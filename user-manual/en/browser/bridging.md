...
> **Note:** The configuration described in this section may also increase the chances that your device is able to seed content to others on the distributed cache, so please consider applying it as well when using CENO in a censoring country.
